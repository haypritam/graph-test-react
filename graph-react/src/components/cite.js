...
export default function Cite() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        //   "http://localhost:5000/paper/testl1/5678",
        //   {
        //     method: "GET",
        //   }
        // );
  ...
  useEffect(() => {
    setGraphData(initializeGraph(data));
  }, [data]);
    ...
    <div>
      ...
      >
        {data && (
          <Card
            variant="outlined"
            style={{ width: 1320, padding: 20, margin: 5 }}
          >
        ...
        >
          ...
          <Card
            variant="outlined"
            style={{ flex: "50%", backgroundColor: "blue" }}
          >
          ...
          <Card
            variant="outlined"
            style={{ flex: "30%", backgroundColor: "green", padding: 10 }}
          >
            <DenseTable />
          </Card>
        </div>
